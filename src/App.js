...
function App() {
  ...
  return (
    <div className="App" style={{scrollBehavior: "smooth"}}>
      ...
      <Element name="episodes" style={{backgroundColor: "rgba(35, 38, 50)", marginTop: "-6em", display: "flex", justifyContent: "center", height: "115em"}}>
        <div style={{backgroundColor: "#ffffff", paddingTop: "10px", width: "50em", height: "110em", color: "black", zIndex: "2"}}>
