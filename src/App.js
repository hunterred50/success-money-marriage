...
function App() {
  ...
  const [vidLink, setVidLink] = useState("https://fast.wistia.net/embed/iframe/f8p75olfhk?videoFoam=true")
  ...
  return (
    <div className="App" style={{scrollBehavior: "smooth"}}>
      ...
      <Element name="episodes" style={{backgroundColor: "rgba(35, 38, 50)", marginTop: "-6em", display: "flex", justifyContent: "center", height: "125em"}}>
        <div style={{backgroundColor: "#ffffff", paddingTop: "10px", width: "50em", height: "120em", color: "black", zIndex: "2"}}>
