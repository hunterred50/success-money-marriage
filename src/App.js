    ...
    <div className="App" style={{scrollBehavior: "smooth"}}>
      ...
      <Element name="episodes" style={{backgroundColor: "rgba(35, 38, 50)", marginTop: "-6em", display: "flex", justifyContent: "center", height: "73em"}}>
        <div style={{backgroundColor: "#ffffff", paddingTop: "10px", width: "50em", height: "80em", color: "black", zIndex: "2"}}>
          ...
          <div onClick={() => handleClick(3)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 8: Who's Working Harder?</div>
          ...
          <div onClick={() => handleVidClick(3)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 7: How to Fight Fair in Business</div>
          <div onClick={() => handleVidClick(3)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 8: Who's Working Harder?</div>
        </div>
      </Element>
      </div>
