...
function App() {
  const [trackLink, setTrackLink] = useState("https://app.kajabi.com/podcasts/medias/2147813317.mp3")
  const [vidLink, setVidLink] = useState("https://fast.wistia.net/embed/iframe/gcleqca7v5?videoFoam=true")
  ...
  const handleClick = (num) => {
    if (num === 1) {
      ...
      setTrackLink("https://app.kajabi.com/podcasts/medias/2147774764.mp3");
    } else if (num === 34) {
      setTrackLink("https://app.kajabi.com/podcasts/medias/2147774770.mp3");
    } else if (num === 35) {
      setTrackLink("https://app.kajabi.com/podcasts/medias/2147790643.mp3");
    } else if (num === 36) {
      setTrackLink("https://app.kajabi.com/podcasts/medias/2147793499.mp3");
    } else if (num === 37) {
      setTrackLink("https://app.kajabi.com/podcasts/medias/2147809078.mp3");
    } else if (num === 38) {
      setTrackLink("https://app.kajabi.com/podcasts/medias/2147809079.mp3");
    } else if (num === 39) {
      setTrackLink("https://app.kajabi.com/podcasts/medias/2147813317.mp3");
    } else if (num === 40) {
      setTrackLink("https://app.kajabi.com/podcasts/medias/2147813318.mp3");
    } else if (num === 41) {
      setTrackLink("https://app.kajabi.com/podcasts/medias/2147813319.mp3");
    }
  };
  ...
  return (
    <div className="App" style={{scrollBehavior: "smooth"}}>
      ...
      <Element name="episodes" style={{backgroundColor: "rgba(35, 38, 50)", marginTop: "-6em", display: "flex", justifyContent: "center", height: "255em"}}>
        <div style={{backgroundColor: "#ffffff", paddingTop: "10px", width: "50em", height: "250em", color: "black", zIndex: "2"}}>
        <h1 style={{fontFamily: "Oswald, sans-serif", fontWeight: "400"}}>Watch the show:</h1>
          ...
          <div onClick={() => handleVidClick(35)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 35: When to Let Go in Business</div>
          <div onClick={() => handleVidClick(36)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 36: Testimonials</div>
          ...
          <div onClick={() => handleClick(35)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 35: When to Let Go in Business</div>
          <div onClick={() => handleClick(36)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 36: Testimonials</div>
