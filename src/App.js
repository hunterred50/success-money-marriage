...
function App() {
  const [trackLink, setTrackLink] = useState("https://app.kajabi.com/podcasts/medias/2147727781.mp3")
  const [vidLink, setVidLink] = useState("https://fast.wistia.net/embed/iframe/gsbkbibpne?videoFoam=true")
