...
function App() {
  ...
  return (
    <div className="App" style={{scrollBehavior: "smooth"}}>
      ...
      <Element name="episodes" style={{backgroundColor: "rgba(35, 38, 50)", marginTop: "-6em", display: "flex", justifyContent: "center", height: "210em"}}>
        ...
        <h1 style={{fontFamily: "Oswald, sans-serif", fontWeight: "400"}}>Watch the show:</h1>
          ...
          <div onClick={() => handleVidClick(33)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 33: </div> */}
          ...
          <div onClick={() => handleClick(33)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 33: </div> */}
        </div>
      </Element>
      </div>
