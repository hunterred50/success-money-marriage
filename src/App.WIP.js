...
function App() {
  const [trackLink, setTrackLink] = useState("https://app.kajabi.com/podcasts/medias/2147772339.mp3")
  const [vidLink, setVidLink] = useState("https://fast.wistia.net/embed/iframe/weuu72e78d?videoFoam=true")
  ...
  const handleClick = (num) => {
    if (num === 1) {
      ...
      setTrackLink("https://app.kajabi.com/podcasts/medias/2147772339.mp3");
    } else if (num === 32) {
      setTrackLink("https://app.kajabi.com/podcasts/medias/2147774197.mp3");
    } else if (num === 33) {
  ...
  return (
    <div className="App" style={{scrollBehavior: "smooth"}}>
        ...
        <div style={opaque}>
          <Element name="home" style={heroDiv}>
            ...
            <div style={{width: "100%", height: "100%", display: "flex", justifyContent: "center"}}>
              ...
              <Link activeClass="active" spy={true} smooth={true} duration={500} style={items} to="ep-vid">Episodes</Link>
      ...
      <div style={{scrollBehavior: "smooth"}} to="home"> {/* adjust height in next two lines */}
      <div style={{backgroundColor: "rgba(35, 38, 50)", marginTop: "-6em", display: "flex", justifyContent: "center", height: "210em"}}>
        <div style={{backgroundColor: "#ffffff", paddingTop: "10px", width: "50em", height: "205em", color: "black", zIndex: "2"}}>
          <Element name="ep-vid"/>
          ...
          <div style={{display: "flex", flexFlow: "column nowrap"}}>
            <Link to="ep-vid" activeClass="active" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(2)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 1: Introduction</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(2)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 2: Building a Relationship While Building a Business</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(3)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 3: How to Fight Fair in Business</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(4)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 4: Money</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(5)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 5: Having Escape Time</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(6)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 6: Who Makes the Final Decision?</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(7)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 7: How to Fight Fair in Business</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(8)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 8: Who's Working Harder?</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(9)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 9: Patience and Forgiveness</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(10)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 10: Negotiating Massive Success</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(11)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 11: How Money Works</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(12)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 12: The Time Value of Money</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(13)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 13: Living an Unrestricted Existence</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(14)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 14: The Rule of 72</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(15)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 15: What to Teach Your Kids About Money</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(16)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 16: Listening to Your Spouse/Partner</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(17)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 17: Taking Time To Reconnect</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(18)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 18: Building Each Other Up</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(19)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 19: Exploring Shared Values</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(20)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 20: Spending and Investing as a Couple</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(21)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 21: 10 Things</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(22)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 22: The More The Merrier</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(23)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 23: Recognition</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(24)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 24: Johnny Depp v. Amber Heard</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(25)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 25: Roe v. Wade</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(26)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 26: Assessing Your Strengths and Weaknesses</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(27)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 27: Communication</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(28)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 28: Building Credibility</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(29)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 29: Should the Rules of Marriage be Rewritten?</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(30)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 30: What Does Personal and Business Success Mean to You?</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(31)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 31: How Much Money Is Enough?</Link>
            {/* <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(32)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 32: Flirting</Link>
            <Link to="ep-vid" spy={true} smooth={true} duration={500} onClick={() => handleVidClick(33)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 33: </Link> */}
          </div>
          <Element name="audio">
          ...
          <div style={{display: "flex", flexFlow: "column nowrap"}}>
            <Link activeClass="active" spy={true} smooth={true} duration={500} to="audio" onClick={() => handleClick(1)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 1: Introduction</Link>
            <Link to="audio" onClick={() => handleClick(2)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 2: Building a Relationship While Building a Business</Link>
            <Link to="audio" onClick={() => handleClick(3)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 3: How to Fight Fair in Business</Link>
            <Link to="audio" onClick={() => handleClick(4)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 4: Money</Link>
            <Link to="audio" onClick={() => handleClick(5)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 5: Having Escape Time</Link>
            <Link to="audio" onClick={() => handleClick(6)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 6: Who Makes the Final Decision?</Link>
            <Link to="audio" onClick={() => handleClick(7)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 7: How to Fight Fair in Business</Link>
            <Link to="audio" onClick={() => handleClick(8)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 8: Who's Working Harder?</Link>
            <Link to="audio" onClick={() => handleClick(9)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 9: Patience and Forgiveness</Link>
            <Link to="audio" onClick={() => handleClick(10)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 10: Negotiating Massive Success</Link>
            <Link to="audio" onClick={() => handleClick(11)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 11: How Money Works</Link>
            <Link to="audio" onClick={() => handleClick(12)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 12: The Time Value of Money</Link>
            <Link to="audio" onClick={() => handleClick(13)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 13: Living an Unrestricted Existence</Link>
            <Link to="audio" onClick={() => handleClick(14)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 14: The Rule of 72</Link>
            <Link to="audio" onClick={() => handleClick(15)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 15: What to Teach Your Kids About Money</Link>
            <Link to="audio" onClick={() => handleClick(16)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 16: Listening to Your Spouse/Partner</Link>
            <Link to="audio" onClick={() => handleClick(17)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 17: Taking Time To Reconnect</Link>
            <Link to="audio" onClick={() => handleClick(18)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 18: Building Each Other Up</Link>
            <Link to="audio" onClick={() => handleClick(19)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 19: Exploring Shared Values</Link>
            <Link to="audio" onClick={() => handleClick(20)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 20: Spending and Investing as a Couple</Link>
            <Link to="audio" onClick={() => handleClick(21)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 21: 10 Things</Link>
            <Link to="audio" onClick={() => handleClick(22)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 22: The More The Merrier</Link>
            <Link to="audio" onClick={() => handleClick(23)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 23: Recognition</Link>
            <Link to="audio" onClick={() => handleClick(24)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 24: Johnny Depp v. Amber Heard</Link>
            <Link to="audio" onClick={() => handleClick(25)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 25: Roe v. Wade</Link>
            <Link to="audio" onClick={() => handleClick(26)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 26: Assessing Your Strengths and Weaknesses</Link>
            <Link to="audio" onClick={() => handleClick(27)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 27: Communication</Link>
            <Link to="audio" onClick={() => handleClick(28)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 28: Building Credibility</Link>
            <Link to="audio" onClick={() => handleClick(29)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 29: Should the Rules of Marriage be Rewritten?</Link>
            <Link to="audio" onClick={() => handleClick(30)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 30: What Does Personal and Business Success Mean to You?</Link>
            <Link to="audio" onClick={() => handleClick(31)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 31: How Much Money Is Enough?</Link>
            {/* <Link to="audio" onClick={() => handleClick(32)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 32: Flirting</Link>
            <Link to="audio" onClick={() => handleClick(33)} style={{borderTop: "1px solid #E5E5E5", borderBottom: "1px solid #E5E5E5", padding: "10px", color: "#868686", cursor: "pointer"}}>Episode 33: </Link> */}
          </div>
        </div>
      </div>
      </div>
